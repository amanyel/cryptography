...
/**
 *
 * Crypto Password is a class to implement password encryption as used on Unix systems.
 * It is compatible with the crypt(3c) system function. 
 * This version is a based on the DES encryption algorithm 
 *
 * @author Amany
 */
  ...
  public static void main(String args[]) {
    ...
    if (args.length >= 2) {
      System.out.println("[" + args[0] + "] [" + args[1] + "] => ["
          + cryptopassword.crypt(args[0], args[1]) + "]");
    }
  }
}
